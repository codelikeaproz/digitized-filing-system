...
|----------|-------------|
| [docs/DEVELOPER_GUIDE.md](docs/DEVELOPER_GUIDE.md) | Architecture, access control, onboarding |
...
| [docs/DATA_MIGRATION_POLICY.md](docs/DATA_MIGRATION_POLICY.md) | Manual document codes, employee number format, migration notes |
